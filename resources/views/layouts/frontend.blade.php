...
<html lang="zxx">
  <head>
    ...
    <title>Professor-X Super Market</title>
  ...
  <body>
    ...
    <div class="humberger__menu__wrapper">
      ...
      <div class="humberger__menu__contact">
        <ul>
          <li><i class="fa fa-envelope"></i> sakthiganapathis97@gmail.com</li>
            ...
            <div class="hero__search">
              ...
              <div class="hero__search__phone">
                ...
                <div class="hero__search__phone__text">
                  <h5><a href="tel:+91-8870656056">+91-8870656056</a></h5>
        ...
        <div class="row">
          <div class="col-lg-3 col-md-6 col-sm-6">
            <div class="footer__about">
              ...
              <ul>
                <li>Address: Bosco Soft Technologies</li>
                <li>Phone:<a href="tel:+91-8870656056">+91-8870656056</a></li>
                <li>Email:sakhtiganapathis97@gmail.com</li>
              </ul>
            </div>
          </div>
            ...
            <div class="footer__copyright">
              <div class="footer__copyright__text">
                <p>
                  ...
                  <a href="https://colorlib.com" target="_blank">Smile</a>
                  <!-- Link back to Colorlib can't be removed. Template is licensed under CC BY 3.0. -->
                </p>
              </div>
